...
class Calculator:
    def __init__(self, master):
        ...
        master.cofing(bgcolor ='gray')

        self.equation=StringVar()
        self.entry_value=''
        Entry(width=17,bgcolor = '#fff',font=('Arial Bold',28),textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='=',relief='flat',bg='ligthblue',command=self.solve).place(x=270, y=350)
        Button(width=11,height=4,text='=',relief='flat',bg='white',command=self.clear).place(x=0, y=350)
